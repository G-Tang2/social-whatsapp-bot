...
// Periodic per-group inactivity sweep, moved here verbatim from the old
// monolithic index.js. See activity.js and the top-of-file comment in
// commands/inactivity.js for the feature description.
...
async function checkGroupInactivity(sock, groupId) {
  ...
  try {
    ...
    await sock.sendMessage(groupId, {
      text: `${tags}\nYou haven't sent a message here in ${INACTIVITY_WARN_AFTER_DAYS}d+. If you stay quiet for another ${INACTIVITY_REMOVE_AFTER_DAYS}d, an admin may remove you from the group for inactivity. Send anything to reset this.`,
      mentions,
    });
...
module.exports = { checkGroupInactivity };
