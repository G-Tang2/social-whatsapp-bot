...
const COMMAND_ARG_GUIDE = `- "in": join/sign up. argText = other people's names, comma-separated, or "" for the sender. See SELF+OTHERS SPLIT, "+N" GUESTS, and "regular players" TOKEN above.
- "out": leave/be removed. Same argText rules as "in" (SELF+OTHERS SPLIT, "+N" GUESTS above - NOT the "regular players" token).
- "paid": mark payment done. Same argText rules as "in" (SELF+OTHERS SPLIT, "+N" GUESTS above - NOT the "regular players" token).
