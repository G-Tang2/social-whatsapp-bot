...
module.exports = {
  ...
  RESPONSE_SCHEMA,
  MAPPABLE_COMMANDS,
  // Exported for lib/snoopyVoice.js's own, much simpler Gemini call (a
  // plain-text restyle, not structured command interpretation) - shares
  // the same lazily-constructed client and per-model thinking-config
  // logic rather than duplicating either.
  getClient,
  getThinkingConfig,
};