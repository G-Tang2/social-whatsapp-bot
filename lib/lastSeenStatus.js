...
// setInterval that calls updateLastSeenStatus() on a timer (same pattern
// as the inactivity-check interval - see lib/inactivityCheck.js), and
...
// Fire-and-forget from index.js's setInterval callback (same convention as
// lib/inactivityCheck.js's checkGroupInactivity) - errors are caught and
// logged here rather than left to reject, since one flaky
