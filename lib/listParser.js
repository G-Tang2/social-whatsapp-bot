...
// returning the cleaned name. A name kept from the current list keeps its
// ORIGINAL addedBy/addedByIsAdmin/owedSince metadata regardless of whether
// "(TBC)" (or the owed-since date) still appears next to it in the edited
// text - see store.js's applyListUpdate.
