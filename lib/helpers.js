...
// `["Extra Guest", "regular players"]` with a stored roster of `["Harry",
// "Bonny"]` becomes `["Extra Guest", "Harry", "Bonny"]`. Shared by
...
// creates it, e.g. "!newlist 20/08 EBC | 13-18 | 8PM start with Harry,
// Bonny, Ron" or, with no location/courts/time mentioned at all, just
// "!newlist 20/08 with Harry, Bonny, Ron".
//
...
// names would make "20/08 | | | Harry, Bonny" (admin didn't mention
