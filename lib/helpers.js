...
// explicit "Henry+1"-style name (that's a real name with a literal "+1"
// suffix typed by whoever's adding Henry, not this shorthand) - this only
...
// A non-"+N" token (a real name, or an explicit "Henry+1") passes through
...
// as if they'd typed "Henry, Henry+1" for someone else.
